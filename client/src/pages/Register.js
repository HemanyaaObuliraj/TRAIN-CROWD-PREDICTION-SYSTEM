    ...
    <>
      ...
      <div style={s.page}>
        ...
        <div style={s.card}>
          ...
          <p style={s.subtitle}>Join RailSense today</p>
...
const s = {
  page: { maxWidth: 680, margin: '0 auto', minHeight: '100vh', background: '#f5f5f0', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '32px 20px' },
